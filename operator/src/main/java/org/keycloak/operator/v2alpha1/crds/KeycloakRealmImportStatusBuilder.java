...
public class KeycloakRealmImportStatusBuilder {
    private final KeycloakRealmStatusCondition readyCondition;
    private final KeycloakRealmStatusCondition startedCondition;
    private final KeycloakRealmStatusCondition hasErrorsCondition;
    ...
    public KeycloakRealmImportStatusBuilder() {
        readyCondition = new KeycloakRealmStatusCondition();
        readyCondition.setType(KeycloakRealmStatusCondition.DONE);
        readyCondition.setStatus(false);

        startedCondition = new KeycloakRealmStatusCondition();
        startedCondition.setType(KeycloakRealmStatusCondition.STARTED);
        startedCondition.setStatus(false);

        hasErrorsCondition = new KeycloakRealmStatusCondition();
        hasErrorsCondition.setType(KeycloakRealmStatusCondition.HAS_ERRORS);
