...
public class PropertyMapper<T> {
    ...
    PropertyMapper(Option<T> option,
                   String to,
    ...
    public static class Builder<T> {
        ...
        Builder(Option<T> option) {
            this.option = option;
            if (Boolean.class.equals(option.getType())) {
                paramLabel(option.getDefaultValue().isEmpty() ? "true|false" : option.getDefaultValue().toString());
            }
        }
    ...
    public static <T> PropertyMapper.Builder<T> fromOption(Option<T> opt) {
        Builder<T> builder = new PropertyMapper.Builder<T>(opt);
        return builder;
    }
}
